  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 ">Statistik Beranda</h1>
          <p className="text-slate-500 ">4 kartu statistik yang tampil di halaman utama</p>
        </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {loading ? (
          ...
          <p className="text-slate-500  col-span-full text-center py-6">Belum ada data.</p>
        ) : (
          list.map((item) => {
      ...
      <Modal isOpen={modalOpen} onClose={() => setModalOpen(false)}>
        <div className="p-6 md:p-8">
          <h2 className="text-xl font-bold text-slate-900  mb-5">{editingId ? 'Edit Statistik' : 'Tambah Statistik'}</h2>
          <div className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700  mb-1.5">Nilai</label>
      ...
      <Modal isOpen={deleteId !== null} onClose={() => setDeleteId(null)}>
        <div className="p-6 md:p-8 text-center">
          <h2 className="text-lg font-bold text-slate-900  mb-2">Hapus statistik ini?</h2>
